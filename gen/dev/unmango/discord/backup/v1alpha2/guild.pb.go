...
// 	protoc        (unknown)
// source: dev/unmango/discord/backup/v1alpha2/guild.proto

package backupv1alpha2
...
type Guild struct {
	...
	xxx_hidden_VerificationLevel           VerificationLevel           `protobuf:"varint,10,opt,name=verification_level,json=verificationLevel,enum=dev.unmango.discord.backup.v1alpha2.VerificationLevel"`
	xxx_hidden_ExplicitContentFilter       ExplicitContentFilter       `protobuf:"varint,11,opt,name=explicit_content_filter,json=explicitContentFilter,enum=dev.unmango.discord.backup.v1alpha2.ExplicitContentFilter"`
	xxx_hidden_DefaultMessageNotifications DefaultMessageNotifications `protobuf:"varint,12,opt,name=default_message_notifications,json=defaultMessageNotifications,enum=dev.unmango.discord.backup.v1alpha2.DefaultMessageNotifications"`
	...
	xxx_hidden_NsfwLevel                   NsfwLevel                   `protobuf:"varint,15,opt,name=nsfw_level,json=nsfwLevel,enum=dev.unmango.discord.backup.v1alpha2.NsfwLevel"`
	xxx_hidden_PremiumTier                 PremiumTier                 `protobuf:"varint,16,opt,name=premium_tier,json=premiumTier,enum=dev.unmango.discord.backup.v1alpha2.PremiumTier"`
...
func (x *Guild) Reset() {
	*x = Guild{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[0]
...
type Channel struct {
	state                                    protoimpl.MessageState  `protogen:"opaque.v1"`
	xxx_hidden_Id                            *string                 `protobuf:"bytes,1,opt,name=id"`
	xxx_hidden_Type                          ChannelType             `protobuf:"varint,2,opt,name=type,enum=dev.unmango.discord.backup.v1alpha2.ChannelType"`
	...
	xxx_hidden_DefaultForumLayout            ForumLayout             `protobuf:"varint,14,opt,name=default_forum_layout,json=defaultForumLayout,enum=dev.unmango.discord.backup.v1alpha2.ForumLayout"`
	xxx_hidden_DefaultSortOrder              SortOrder               `protobuf:"varint,15,opt,name=default_sort_order,json=defaultSortOrder,enum=dev.unmango.discord.backup.v1alpha2.SortOrder"`
	...
	xxx_hidden_VideoQualityMode              VideoQualityMode        `protobuf:"varint,18,opt,name=video_quality_mode,json=videoQualityMode,enum=dev.unmango.discord.backup.v1alpha2.VideoQualityMode"`
...
func (x *Channel) Reset() {
	*x = Channel{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Role) Reset() {
	*x = Role{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *User) Reset() {
	*x = User{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Member) Reset() {
	*x = Member{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Emoji) Reset() {
	*x = Emoji{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type Sticker struct {
	...
	xxx_hidden_FormatType  StickerFormatType      `protobuf:"varint,6,opt,name=format_type,json=formatType,enum=dev.unmango.discord.backup.v1alpha2.StickerFormatType"`
...
func (x *Sticker) Reset() {
	*x = Sticker{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type Webhook struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Id              *string                `protobuf:"bytes,1,opt,name=id"`
	xxx_hidden_Type            WebhookType            `protobuf:"varint,2,opt,name=type,enum=dev.unmango.discord.backup.v1alpha2.WebhookType"`
...
func (x *Webhook) Reset() {
	*x = Webhook{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ScheduledEventEntityMetadata) Reset() {
	*x = ScheduledEventEntityMetadata{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type ScheduledEvent struct {
	...
	xxx_hidden_PrivacyLevel       PrivacyLevel                  `protobuf:"varint,9,opt,name=privacy_level,json=privacyLevel,enum=dev.unmango.discord.backup.v1alpha2.PrivacyLevel"`
	xxx_hidden_Status             ScheduledEventStatus          `protobuf:"varint,10,opt,name=status,enum=dev.unmango.discord.backup.v1alpha2.ScheduledEventStatus"`
	xxx_hidden_EntityType         ScheduledEventEntityType      `protobuf:"varint,11,opt,name=entity_type,json=entityType,enum=dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityType"`
...
func (x *ScheduledEvent) Reset() {
	*x = ScheduledEvent{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *AutoModTriggerMetadata) Reset() {
	*x = AutoModTriggerMetadata{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AutoModAction struct {
	state                      protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_Type            AutoModActionType      `protobuf:"varint,1,opt,name=type,enum=dev.unmango.discord.backup.v1alpha2.AutoModActionType"`
...
func (x *AutoModAction) Reset() {
	*x = AutoModAction{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type AutoModRule struct {
	...
	xxx_hidden_Name             *string                 `protobuf:"bytes,3,opt,name=name"`
	xxx_hidden_CreatorId        *string                 `protobuf:"bytes,4,opt,name=creator_id,json=creatorId"`
	xxx_hidden_EventType        AutoModEventType        `protobuf:"varint,5,opt,name=event_type,json=eventType,enum=dev.unmango.discord.backup.v1alpha2.AutoModEventType"`
	xxx_hidden_TriggerType      AutoModTriggerType      `protobuf:"varint,6,opt,name=trigger_type,json=triggerType,enum=dev.unmango.discord.backup.v1alpha2.AutoModTriggerType"`
...
func (x *AutoModRule) Reset() {
	*x = AutoModRule{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Invite) Reset() {
	*x = Invite{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_unmango_discord_backup_v1alpha2_guild_proto protoreflect.FileDescriptor

const file_dev_unmango_discord_backup_v1alpha2_guild_proto_rawDesc = "" +
	"\n" +
	"/dev/unmango/discord/backup/v1alpha2/guild.proto\x12#dev.unmango.discord.backup.v1alpha2\x1a/dev/unmango/discord/backup/v1alpha2/types.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x0e\n" +
	"\x05Guild\x12\x0e\n" +
	...
	" \x01(\x0e26.dev.unmango.discord.backup.v1alpha2.VerificationLevelR\x11verificationLevel\x12r\n" +
	"\x17explicit_content_filter\x18\v \x01(\x0e2:.dev.unmango.discord.backup.v1alpha2.ExplicitContentFilterR\x15explicitContentFilter\x12\x84\x01\n" +
	"\x1ddefault_message_notifications\x18\f \x01(\x0e2@.dev.unmango.discord.backup.v1alpha2.DefaultMessageNotificationsR\x1bdefaultMessageNotifications\x120\n" +
	...
	"\n" +
	"nsfw_level\x18\x0f \x01(\x0e2..dev.unmango.discord.backup.v1alpha2.NsfwLevelR\tnsfwLevel\x12S\n" +
	"\fpremium_tier\x18\x10 \x01(\x0e20.dev.unmango.discord.backup.v1alpha2.PremiumTierR\vpremiumTier\x12C\n" +
	...
	"\x04type\x18\x02 \x01(\x0e20.dev.unmango.discord.backup.v1alpha2.ChannelTypeR\x04type\x12\x19\n" +
	...
	"\x15permission_overwrites\x18\v \x03(\v28.dev.unmango.discord.backup.v1alpha2.PermissionOverwriteR\x14permissionOverwrites\x12A\n" +
	...
	"\x14default_forum_layout\x18\x0e \x01(\x0e20.dev.unmango.discord.backup.v1alpha2.ForumLayoutR\x12defaultForumLayout\x12\\\n" +
	"\x12default_sort_order\x18\x0f \x01(\x0e2..dev.unmango.discord.backup.v1alpha2.SortOrderR\x10defaultSortOrder\x12T\n" +
	"\x0eavailable_tags\x18\x10 \x03(\v2-.dev.unmango.discord.backup.v1alpha2.ForumTagR\ravailableTags\x12j\n" +
	"\x16default_reaction_emoji\x18\x11 \x01(\v24.dev.unmango.discord.backup.v1alpha2.DefaultReactionR\x14defaultReactionEmoji\x12c\n" +
	"\x12video_quality_mode\x18\x12 \x01(\x0e25.dev.unmango.discord.backup.v1alpha2.VideoQualityModeR\x10videoQualityMode\x12I\n" +
	"\"default_thread_rate_limit_per_user\x18\x13 \x01(\x05R\x1ddefaultThreadRateLimitPerUser\x12\\\n" +
	"\x0fthread_metadata\x18\x14 \x01(\v23.dev.unmango.discord.backup.v1alpha2.ThreadMetadataR\x0ethreadMetadata\"\xf6\x02\n" +
	"\x04Role\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\x04tags\x18\v \x01(\v2,.dev.unmango.discord.backup.v1alpha2.RoleTagR\x04tags\x12\x14\n" +
	...
	"\vformat_type\x18\x06 \x01(\x0e26.dev.unmango.discord.backup.v1alpha2.StickerFormatTypeR\n" +
	"formatType\x12\x1c\n" +
	...
	"\aWebhook\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12D\n" +
	"\x04type\x18\x02 \x01(\x0e20.dev.unmango.discord.backup.v1alpha2.WebhookTypeR\x04type\x12 \n" +
	...
	"\rprivacy_level\x18\t \x01(\x0e21.dev.unmango.discord.backup.v1alpha2.PrivacyLevelR\fprivacyLevel\x12Q\n" +
	"\x06status\x18\n" +
	" \x01(\x0e29.dev.unmango.discord.backup.v1alpha2.ScheduledEventStatusR\x06status\x12^\n" +
	"\ventity_type\x18\v \x01(\x0e2=.dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityTypeR\n" +
	"entityType\x12\"\n" +
	"\tentity_id\x18\f \x01(\tB\x05\xaa\x01\x02\b\x01R\bentityId\x12j\n" +
	"\x0fentity_metadata\x18\r \x01(\v2A.dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityMetadataR\x0eentityMetadata\x12\x1d\n" +
	"\n" +
	...
	"\rAutoModAction\x12J\n" +
	"\x04type\x18\x01 \x01(\x0e26.dev.unmango.discord.backup.v1alpha2.AutoModActionTypeR\x04type\x12$\n" +
	"\n" +
	...
	"\n" +
	"event_type\x18\x05 \x01(\x0e25.dev.unmango.discord.backup.v1alpha2.AutoModEventTypeR\teventType\x12Z\n" +
	"\ftrigger_type\x18\x06 \x01(\x0e27.dev.unmango.discord.backup.v1alpha2.AutoModTriggerTypeR\vtriggerType\x12f\n" +
	"\x10trigger_metadata\x18\a \x01(\v2;.dev.unmango.discord.backup.v1alpha2.AutoModTriggerMetadataR\x0ftriggerMetadata\x12L\n" +
	"\aactions\x18\b \x03(\v22.dev.unmango.discord.backup.v1alpha2.AutoModActionR\aactions\x12\x18\n" +
	...
	"\arevoked\x18\t \x01(\bR\arevokedB\xc6\x02\n" +
	"'com.dev.unmango.discord.backup.v1alpha2B\n" +
	"GuildProtoP\x01Z^github.com/unstoppablemango/go-protocmd/gen/dev/unmango/discord/backup/v1alpha2;backupv1alpha2\xa2\x02\x04DUDB\xaa\x02#Dev.Unmango.Discord.Backup.V1alpha2\xca\x02#Dev\\Unmango\\Discord\\Backup\\V1alpha2\xe2\x02/Dev\\Unmango\\Discord\\Backup\\V1alpha2\\GPBMetadata\xea\x02'Dev::Unmango::Discord::Backup::V1alpha2b\beditionsp\xe9\a"

var file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_dev_unmango_discord_backup_v1alpha2_guild_proto_goTypes = []any{
	(*Guild)(nil),                        // 0: dev.unmango.discord.backup.v1alpha2.Guild
	(*Channel)(nil),                      // 1: dev.unmango.discord.backup.v1alpha2.Channel
	(*Role)(nil),                         // 2: dev.unmango.discord.backup.v1alpha2.Role
	(*User)(nil),                         // 3: dev.unmango.discord.backup.v1alpha2.User
	(*Member)(nil),                       // 4: dev.unmango.discord.backup.v1alpha2.Member
	(*Emoji)(nil),                        // 5: dev.unmango.discord.backup.v1alpha2.Emoji
	(*Sticker)(nil),                      // 6: dev.unmango.discord.backup.v1alpha2.Sticker
	(*Webhook)(nil),                      // 7: dev.unmango.discord.backup.v1alpha2.Webhook
	(*ScheduledEventEntityMetadata)(nil), // 8: dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityMetadata
	(*ScheduledEvent)(nil),               // 9: dev.unmango.discord.backup.v1alpha2.ScheduledEvent
	(*AutoModTriggerMetadata)(nil),       // 10: dev.unmango.discord.backup.v1alpha2.AutoModTriggerMetadata
	(*AutoModAction)(nil),                // 11: dev.unmango.discord.backup.v1alpha2.AutoModAction
	(*AutoModRule)(nil),                  // 12: dev.unmango.discord.backup.v1alpha2.AutoModRule
	(*Invite)(nil),                       // 13: dev.unmango.discord.backup.v1alpha2.Invite
	(VerificationLevel)(0),               // 14: dev.unmango.discord.backup.v1alpha2.VerificationLevel
	(ExplicitContentFilter)(0),           // 15: dev.unmango.discord.backup.v1alpha2.ExplicitContentFilter
	(DefaultMessageNotifications)(0),     // 16: dev.unmango.discord.backup.v1alpha2.DefaultMessageNotifications
	(NsfwLevel)(0),                       // 17: dev.unmango.discord.backup.v1alpha2.NsfwLevel
	(PremiumTier)(0),                     // 18: dev.unmango.discord.backup.v1alpha2.PremiumTier
	(*timestamppb.Timestamp)(nil),        // 19: google.protobuf.Timestamp
	(ChannelType)(0),                     // 20: dev.unmango.discord.backup.v1alpha2.ChannelType
	(*PermissionOverwrite)(nil),          // 21: dev.unmango.discord.backup.v1alpha2.PermissionOverwrite
	(ForumLayout)(0),                     // 22: dev.unmango.discord.backup.v1alpha2.ForumLayout
	(SortOrder)(0),                       // 23: dev.unmango.discord.backup.v1alpha2.SortOrder
	(*ForumTag)(nil),                     // 24: dev.unmango.discord.backup.v1alpha2.ForumTag
	(*DefaultReaction)(nil),              // 25: dev.unmango.discord.backup.v1alpha2.DefaultReaction
	(VideoQualityMode)(0),                // 26: dev.unmango.discord.backup.v1alpha2.VideoQualityMode
	(*ThreadMetadata)(nil),               // 27: dev.unmango.discord.backup.v1alpha2.ThreadMetadata
	(*RoleTag)(nil),                      // 28: dev.unmango.discord.backup.v1alpha2.RoleTag
	(StickerFormatType)(0),               // 29: dev.unmango.discord.backup.v1alpha2.StickerFormatType
	(WebhookType)(0),                     // 30: dev.unmango.discord.backup.v1alpha2.WebhookType
	(PrivacyLevel)(0),                    // 31: dev.unmango.discord.backup.v1alpha2.PrivacyLevel
	(ScheduledEventStatus)(0),            // 32: dev.unmango.discord.backup.v1alpha2.ScheduledEventStatus
	(ScheduledEventEntityType)(0),        // 33: dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityType
	(AutoModActionType)(0),               // 34: dev.unmango.discord.backup.v1alpha2.AutoModActionType
	(AutoModEventType)(0),                // 35: dev.unmango.discord.backup.v1alpha2.AutoModEventType
	(AutoModTriggerType)(0),              // 36: dev.unmango.discord.backup.v1alpha2.AutoModTriggerType
}
var file_dev_unmango_discord_backup_v1alpha2_guild_proto_depIdxs = []int32{
	14, // 0: dev.unmango.discord.backup.v1alpha2.Guild.verification_level:type_name -> dev.unmango.discord.backup.v1alpha2.VerificationLevel
	15, // 1: dev.unmango.discord.backup.v1alpha2.Guild.explicit_content_filter:type_name -> dev.unmango.discord.backup.v1alpha2.ExplicitContentFilter
	16, // 2: dev.unmango.discord.backup.v1alpha2.Guild.default_message_notifications:type_name -> dev.unmango.discord.backup.v1alpha2.DefaultMessageNotifications
	17, // 3: dev.unmango.discord.backup.v1alpha2.Guild.nsfw_level:type_name -> dev.unmango.discord.backup.v1alpha2.NsfwLevel
	18, // 4: dev.unmango.discord.backup.v1alpha2.Guild.premium_tier:type_name -> dev.unmango.discord.backup.v1alpha2.PremiumTier
	19, // 5: dev.unmango.discord.backup.v1alpha2.Guild.joined_at:type_name -> google.protobuf.Timestamp
	20, // 6: dev.unmango.discord.backup.v1alpha2.Channel.type:type_name -> dev.unmango.discord.backup.v1alpha2.ChannelType
	21, // 7: dev.unmango.discord.backup.v1alpha2.Channel.permission_overwrites:type_name -> dev.unmango.discord.backup.v1alpha2.PermissionOverwrite
	22, // 8: dev.unmango.discord.backup.v1alpha2.Channel.default_forum_layout:type_name -> dev.unmango.discord.backup.v1alpha2.ForumLayout
	23, // 9: dev.unmango.discord.backup.v1alpha2.Channel.default_sort_order:type_name -> dev.unmango.discord.backup.v1alpha2.SortOrder
	24, // 10: dev.unmango.discord.backup.v1alpha2.Channel.available_tags:type_name -> dev.unmango.discord.backup.v1alpha2.ForumTag
	25, // 11: dev.unmango.discord.backup.v1alpha2.Channel.default_reaction_emoji:type_name -> dev.unmango.discord.backup.v1alpha2.DefaultReaction
	26, // 12: dev.unmango.discord.backup.v1alpha2.Channel.video_quality_mode:type_name -> dev.unmango.discord.backup.v1alpha2.VideoQualityMode
	27, // 13: dev.unmango.discord.backup.v1alpha2.Channel.thread_metadata:type_name -> dev.unmango.discord.backup.v1alpha2.ThreadMetadata
	28, // 14: dev.unmango.discord.backup.v1alpha2.Role.tags:type_name -> dev.unmango.discord.backup.v1alpha2.RoleTag
	19, // 15: dev.unmango.discord.backup.v1alpha2.Member.joined_at:type_name -> google.protobuf.Timestamp
	19, // 16: dev.unmango.discord.backup.v1alpha2.Member.premium_since:type_name -> google.protobuf.Timestamp
	19, // 17: dev.unmango.discord.backup.v1alpha2.Member.communication_disabled_until:type_name -> google.protobuf.Timestamp
	29, // 18: dev.unmango.discord.backup.v1alpha2.Sticker.format_type:type_name -> dev.unmango.discord.backup.v1alpha2.StickerFormatType
	30, // 19: dev.unmango.discord.backup.v1alpha2.Webhook.type:type_name -> dev.unmango.discord.backup.v1alpha2.WebhookType
	19, // 20: dev.unmango.discord.backup.v1alpha2.ScheduledEvent.scheduled_start_time:type_name -> google.protobuf.Timestamp
	19, // 21: dev.unmango.discord.backup.v1alpha2.ScheduledEvent.scheduled_end_time:type_name -> google.protobuf.Timestamp
	31, // 22: dev.unmango.discord.backup.v1alpha2.ScheduledEvent.privacy_level:type_name -> dev.unmango.discord.backup.v1alpha2.PrivacyLevel
	32, // 23: dev.unmango.discord.backup.v1alpha2.ScheduledEvent.status:type_name -> dev.unmango.discord.backup.v1alpha2.ScheduledEventStatus
	33, // 24: dev.unmango.discord.backup.v1alpha2.ScheduledEvent.entity_type:type_name -> dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityType
	8,  // 25: dev.unmango.discord.backup.v1alpha2.ScheduledEvent.entity_metadata:type_name -> dev.unmango.discord.backup.v1alpha2.ScheduledEventEntityMetadata
	34, // 26: dev.unmango.discord.backup.v1alpha2.AutoModAction.type:type_name -> dev.unmango.discord.backup.v1alpha2.AutoModActionType
	35, // 27: dev.unmango.discord.backup.v1alpha2.AutoModRule.event_type:type_name -> dev.unmango.discord.backup.v1alpha2.AutoModEventType
	36, // 28: dev.unmango.discord.backup.v1alpha2.AutoModRule.trigger_type:type_name -> dev.unmango.discord.backup.v1alpha2.AutoModTriggerType
	10, // 29: dev.unmango.discord.backup.v1alpha2.AutoModRule.trigger_metadata:type_name -> dev.unmango.discord.backup.v1alpha2.AutoModTriggerMetadata
	11, // 30: dev.unmango.discord.backup.v1alpha2.AutoModRule.actions:type_name -> dev.unmango.discord.backup.v1alpha2.AutoModAction
	19, // 31: dev.unmango.discord.backup.v1alpha2.Invite.created_at:type_name -> google.protobuf.Timestamp
...
func init() { file_dev_unmango_discord_backup_v1alpha2_guild_proto_init() }
func file_dev_unmango_discord_backup_v1alpha2_guild_proto_init() {
	if File_dev_unmango_discord_backup_v1alpha2_guild_proto != nil {
		return
	}
	file_dev_unmango_discord_backup_v1alpha2_types_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_unmango_discord_backup_v1alpha2_guild_proto_rawDesc), len(file_dev_unmango_discord_backup_v1alpha2_guild_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_unmango_discord_backup_v1alpha2_guild_proto_goTypes,
		DependencyIndexes: file_dev_unmango_discord_backup_v1alpha2_guild_proto_depIdxs,
		MessageInfos:      file_dev_unmango_discord_backup_v1alpha2_guild_proto_msgTypes,
	}.Build()
	File_dev_unmango_discord_backup_v1alpha2_guild_proto = out.File
	file_dev_unmango_discord_backup_v1alpha2_guild_proto_goTypes = nil
	file_dev_unmango_discord_backup_v1alpha2_guild_proto_depIdxs = nil
}
