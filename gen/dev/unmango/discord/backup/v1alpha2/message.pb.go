...
// 	protoc        (unknown)
// source: dev/unmango/discord/backup/v1alpha2/message.proto
...
func (x *Attachment) Reset() {
	*x = Attachment{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[0]
...
func (x *EmbedFooter) Reset() {
	*x = EmbedFooter{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EmbedImage) Reset() {
	*x = EmbedImage{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EmbedThumbnail) Reset() {
	*x = EmbedThumbnail{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EmbedVideo) Reset() {
	*x = EmbedVideo{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EmbedProvider) Reset() {
	*x = EmbedProvider{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EmbedAuthor) Reset() {
	*x = EmbedAuthor{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *EmbedField) Reset() {
	*x = EmbedField{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type Embed struct {
	...
	xxx_hidden_Type        EmbedType              `protobuf:"varint,2,opt,name=type,enum=dev.unmango.discord.backup.v1alpha2.EmbedType"`
	xxx_hidden_Description *string                `protobuf:"bytes,3,opt,name=description"`
...
func (x *Embed) Reset() {
	*x = Embed{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ReactionEmoji) Reset() {
	*x = ReactionEmoji{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Reaction) Reset() {
	*x = Reaction{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type MentionChannel struct {
	...
	xxx_hidden_Type        ChannelType            `protobuf:"varint,3,opt,name=type,enum=dev.unmango.discord.backup.v1alpha2.ChannelType"`
...
func (x *MentionChannel) Reset() {
	*x = MentionChannel{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
type Message struct {
	...
	xxx_hidden_Type                MessageType            `protobuf:"varint,16,opt,name=type,enum=dev.unmango.discord.backup.v1alpha2.MessageType"`
...
func (x *Message) Reset() {
	*x = Message{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ChannelMessages) Reset() {
	*x = ChannelMessages{}
	mi := &file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_dev_unmango_discord_backup_v1alpha2_message_proto protoreflect.FileDescriptor

const file_dev_unmango_discord_backup_v1alpha2_message_proto_rawDesc = "" +
	"\n" +
	"1dev/unmango/discord/backup/v1alpha2/message.proto\x12#dev.unmango.discord.backup.v1alpha2\x1a/dev/unmango/discord/backup/v1alpha2/types.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x8d\x03\n" +
	"\n" +
	"Attachment\x12\x0e\n" +
	...
	"\x04type\x18\x02 \x01(\x0e2..dev.unmango.discord.backup.v1alpha2.EmbedTypeR\x04type\x12'\n" +
	...
	"\x06footer\x18\a \x01(\v20.dev.unmango.discord.backup.v1alpha2.EmbedFooterR\x06footer\x12E\n" +
	"\x05image\x18\b \x01(\v2/.dev.unmango.discord.backup.v1alpha2.EmbedImageR\x05image\x12Q\n" +
	"\tthumbnail\x18\t \x01(\v23.dev.unmango.discord.backup.v1alpha2.EmbedThumbnailR\tthumbnail\x12E\n" +
	"\x05video\x18\n" +
	" \x01(\v2/.dev.unmango.discord.backup.v1alpha2.EmbedVideoR\x05video\x12N\n" +
	"\bprovider\x18\v \x01(\v22.dev.unmango.discord.backup.v1alpha2.EmbedProviderR\bprovider\x12H\n" +
	"\x06author\x18\f \x01(\v20.dev.unmango.discord.backup.v1alpha2.EmbedAuthorR\x06author\x12G\n" +
	"\x06fields\x18\r \x03(\v2/.dev.unmango.discord.backup.v1alpha2.EmbedFieldR\x06fields\"]\n" +
	...
	"\bReaction\x12H\n" +
	"\x05emoji\x18\x01 \x01(\v22.dev.unmango.discord.backup.v1alpha2.ReactionEmojiR\x05emoji\x12\x14\n" +
	...
	"\x04type\x18\x03 \x01(\x0e20.dev.unmango.discord.backup.v1alpha2.ChannelTypeR\x04type\x12\x12\n" +
	...
	"\x10mention_channels\x18\v \x03(\v23.dev.unmango.discord.backup.v1alpha2.MentionChannelR\x0fmentionChannels\x12Q\n" +
	"\vattachments\x18\f \x03(\v2/.dev.unmango.discord.backup.v1alpha2.AttachmentR\vattachments\x12B\n" +
	"\x06embeds\x18\r \x03(\v2*.dev.unmango.discord.backup.v1alpha2.EmbedR\x06embeds\x12K\n" +
	"\treactions\x18\x0e \x03(\v2-.dev.unmango.discord.backup.v1alpha2.ReactionR\treactions\x12\x16\n" +
	"\x06pinned\x18\x0f \x01(\bR\x06pinned\x12D\n" +
	"\x04type\x18\x10 \x01(\x0e20.dev.unmango.discord.backup.v1alpha2.MessageTypeR\x04type\x12$\n" +
	"\n" +
	...
	"\bmessages\x18\x02 \x03(\v2,.dev.unmango.discord.backup.v1alpha2.MessageR\bmessagesB\xc8\x02\n" +
	"'com.dev.unmango.discord.backup.v1alpha2B\fMessageProtoP\x01Z^github.com/unstoppablemango/go-protocmd/gen/dev/unmango/discord/backup/v1alpha2;backupv1alpha2\xa2\x02\x04DUDB\xaa\x02#Dev.Unmango.Discord.Backup.V1alpha2\xca\x02#Dev\\Unmango\\Discord\\Backup\\V1alpha2\xe2\x02/Dev\\Unmango\\Discord\\Backup\\V1alpha2\\GPBMetadata\xea\x02'Dev::Unmango::Discord::Backup::V1alpha2b\beditionsp\xe9\a"

var file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_dev_unmango_discord_backup_v1alpha2_message_proto_goTypes = []any{
	(*Attachment)(nil),            // 0: dev.unmango.discord.backup.v1alpha2.Attachment
	(*EmbedFooter)(nil),           // 1: dev.unmango.discord.backup.v1alpha2.EmbedFooter
	(*EmbedImage)(nil),            // 2: dev.unmango.discord.backup.v1alpha2.EmbedImage
	(*EmbedThumbnail)(nil),        // 3: dev.unmango.discord.backup.v1alpha2.EmbedThumbnail
	(*EmbedVideo)(nil),            // 4: dev.unmango.discord.backup.v1alpha2.EmbedVideo
	(*EmbedProvider)(nil),         // 5: dev.unmango.discord.backup.v1alpha2.EmbedProvider
	(*EmbedAuthor)(nil),           // 6: dev.unmango.discord.backup.v1alpha2.EmbedAuthor
	(*EmbedField)(nil),            // 7: dev.unmango.discord.backup.v1alpha2.EmbedField
	(*Embed)(nil),                 // 8: dev.unmango.discord.backup.v1alpha2.Embed
	(*ReactionEmoji)(nil),         // 9: dev.unmango.discord.backup.v1alpha2.ReactionEmoji
	(*Reaction)(nil),              // 10: dev.unmango.discord.backup.v1alpha2.Reaction
	(*MentionChannel)(nil),        // 11: dev.unmango.discord.backup.v1alpha2.MentionChannel
	(*Message)(nil),               // 12: dev.unmango.discord.backup.v1alpha2.Message
	(*ChannelMessages)(nil),       // 13: dev.unmango.discord.backup.v1alpha2.ChannelMessages
	(EmbedType)(0),                // 14: dev.unmango.discord.backup.v1alpha2.EmbedType
	(*timestamppb.Timestamp)(nil), // 15: google.protobuf.Timestamp
	(ChannelType)(0),              // 16: dev.unmango.discord.backup.v1alpha2.ChannelType
	(MessageType)(0),              // 17: dev.unmango.discord.backup.v1alpha2.MessageType
}
var file_dev_unmango_discord_backup_v1alpha2_message_proto_depIdxs = []int32{
	14, // 0: dev.unmango.discord.backup.v1alpha2.Embed.type:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedType
	15, // 1: dev.unmango.discord.backup.v1alpha2.Embed.timestamp:type_name -> google.protobuf.Timestamp
	1,  // 2: dev.unmango.discord.backup.v1alpha2.Embed.footer:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedFooter
	2,  // 3: dev.unmango.discord.backup.v1alpha2.Embed.image:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedImage
	3,  // 4: dev.unmango.discord.backup.v1alpha2.Embed.thumbnail:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedThumbnail
	4,  // 5: dev.unmango.discord.backup.v1alpha2.Embed.video:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedVideo
	5,  // 6: dev.unmango.discord.backup.v1alpha2.Embed.provider:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedProvider
	6,  // 7: dev.unmango.discord.backup.v1alpha2.Embed.author:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedAuthor
	7,  // 8: dev.unmango.discord.backup.v1alpha2.Embed.fields:type_name -> dev.unmango.discord.backup.v1alpha2.EmbedField
	9,  // 9: dev.unmango.discord.backup.v1alpha2.Reaction.emoji:type_name -> dev.unmango.discord.backup.v1alpha2.ReactionEmoji
	16, // 10: dev.unmango.discord.backup.v1alpha2.MentionChannel.type:type_name -> dev.unmango.discord.backup.v1alpha2.ChannelType
	15, // 11: dev.unmango.discord.backup.v1alpha2.Message.timestamp:type_name -> google.protobuf.Timestamp
	15, // 12: dev.unmango.discord.backup.v1alpha2.Message.edited_timestamp:type_name -> google.protobuf.Timestamp
	11, // 13: dev.unmango.discord.backup.v1alpha2.Message.mention_channels:type_name -> dev.unmango.discord.backup.v1alpha2.MentionChannel
	0,  // 14: dev.unmango.discord.backup.v1alpha2.Message.attachments:type_name -> dev.unmango.discord.backup.v1alpha2.Attachment
	8,  // 15: dev.unmango.discord.backup.v1alpha2.Message.embeds:type_name -> dev.unmango.discord.backup.v1alpha2.Embed
	10, // 16: dev.unmango.discord.backup.v1alpha2.Message.reactions:type_name -> dev.unmango.discord.backup.v1alpha2.Reaction
	17, // 17: dev.unmango.discord.backup.v1alpha2.Message.type:type_name -> dev.unmango.discord.backup.v1alpha2.MessageType
	12, // 18: dev.unmango.discord.backup.v1alpha2.ChannelMessages.messages:type_name -> dev.unmango.discord.backup.v1alpha2.Message
...
func init() { file_dev_unmango_discord_backup_v1alpha2_message_proto_init() }
func file_dev_unmango_discord_backup_v1alpha2_message_proto_init() {
	if File_dev_unmango_discord_backup_v1alpha2_message_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dev_unmango_discord_backup_v1alpha2_message_proto_rawDesc), len(file_dev_unmango_discord_backup_v1alpha2_message_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   14,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dev_unmango_discord_backup_v1alpha2_message_proto_goTypes,
		DependencyIndexes: file_dev_unmango_discord_backup_v1alpha2_message_proto_depIdxs,
		MessageInfos:      file_dev_unmango_discord_backup_v1alpha2_message_proto_msgTypes,
	}.Build()
	File_dev_unmango_discord_backup_v1alpha2_message_proto = out.File
	file_dev_unmango_discord_backup_v1alpha2_message_proto_goTypes = nil
	file_dev_unmango_discord_backup_v1alpha2_message_proto_depIdxs = nil
}
