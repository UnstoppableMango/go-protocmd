...
const (
	FileService_Read_FullMethodName         = "/dev.unmango.protofs.file.v1alpha2.FileService/Read"
	FileService_ReadAt_FullMethodName       = "/dev.unmango.protofs.file.v1alpha2.FileService/ReadAt"
	FileService_Readdir_FullMethodName      = "/dev.unmango.protofs.file.v1alpha2.FileService/Readdir"
	FileService_ReaddirNames_FullMethodName = "/dev.unmango.protofs.file.v1alpha2.FileService/ReaddirNames"
	FileService_Stat_FullMethodName         = "/dev.unmango.protofs.file.v1alpha2.FileService/Stat"
	FileService_Truncate_FullMethodName     = "/dev.unmango.protofs.file.v1alpha2.FileService/Truncate"
	FileService_Write_FullMethodName        = "/dev.unmango.protofs.file.v1alpha2.FileService/Write"
	FileService_WriteAt_FullMethodName      = "/dev.unmango.protofs.file.v1alpha2.FileService/WriteAt"
)
...
type FileServiceClient interface {
	...
	ReaddirNames(ctx context.Context, in *ReaddirNamesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReaddirNamesResponse], error)
...
func (c *fileServiceClient) ReaddirNames(ctx context.Context, in *ReaddirNamesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ReaddirNamesResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &FileService_ServiceDesc.Streams[1], FileService_ReaddirNames_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ReaddirNamesRequest, ReaddirNamesResponse]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FileService_ReaddirNamesClient = grpc.ServerStreamingClient[ReaddirNamesResponse]
...
type FileServiceServer interface {
	...
	ReaddirNames(*ReaddirNamesRequest, grpc.ServerStreamingServer[ReaddirNamesResponse]) error
...
func (UnimplementedFileServiceServer) ReaddirNames(*ReaddirNamesRequest, grpc.ServerStreamingServer[ReaddirNamesResponse]) error {
	return status.Error(codes.Unimplemented, "method ReaddirNames not implemented")
}
...
func _FileService_ReaddirNames_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(ReaddirNamesRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(FileServiceServer).ReaddirNames(m, &grpc.GenericServerStream[ReaddirNamesRequest, ReaddirNamesResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type FileService_ReaddirNamesServer = grpc.ServerStreamingServer[ReaddirNamesResponse]
...
var FileService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dev.unmango.protofs.file.v1alpha2.FileService",
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "ReaddirNames",
			Handler:       _FileService_ReaddirNames_Handler,
			ServerStreams: true,
		},
	},
	Metadata: "dev/unmango/protofs/file/v1alpha2/file.proto",
}
